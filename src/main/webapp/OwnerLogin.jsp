    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="OwnerRegister.jsp">OwnerRegister</a></li>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row no-gutters">
          <div class="content col-xl-5 d-flex align-items-stretch">
            <div class="content">
           <center> <h2 class="bx bx-user">Owner Login</h2></center><br><br>
            <form name="loginForm" action="OwnerLoginServlet" method="post">
            ...
            <div class="icon-boxes d-flex flex-column justify-content-center">
              <div class="row">
                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
                  ...
                  <img src="assets/img/login.png" class="img-fluid" alt="" style="margin-right: 60px">
