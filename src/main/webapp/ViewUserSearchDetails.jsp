...
<br><br><br>
  ...
  <!--   <section id="tabs" class="tabs">
   ...
   <!--  <section id="services" class="services section-bg ">
    ...
    <!-- ======= Portfolio Section ======= -->
    <section id="portfolio" class="portfolio" style="background-image: url(assets/img/view1.jpg)"><br><br>
    <div class="portfolio" style="background-image: url(assets/img/view1.jpg)">
      <div class="container" data-aos="fade-up" >

        <div class="section-title">
          <h2>User Electrical vehicle  Bunk Details</h2>
          <!-- <p>Magnam dolores commodi suscipit. Necessitatibus eius consequatur ex aliquid fuga eum quidem. Sit sint consectetur velit. Quisquam quos quisquam cupiditate. Et nemo qui impedit suscipit alias ea.</p> -->
        </div>
         ...
         <div class="row">
          ...
          <div class="col-md-12">
                    ...
                    <table class="table table-bordered" style="color:black">
                     ...
                     ResultSet rs=st.executeQuery("SELECT search.id,ev_bunk.slot,ev_bunk.capacity,ev_bunk.chargetime,search.bunklocation,search.bunkarea from search INNER JOIN ev_bunk on search.bunkid= ev_bunk.bunkid");
                             

 
                    /*  SELECT Customers.CustomerName, Orders.OrderI
                     FROM Customers
                     CROSS JOIN Orders
                     WHERE Customers.CustomerID = Orders.CustomerID; */
                    	/* ResultSet rs=st.executeQuery("select bunklocation, bunkarea,slot from ev_bunk"); */	
                    		 
                     //while(rs.next())
                     if(rs.next() == false) {
                    	%>
                    	<h4 style="text-align:right;margin-right:70px"><b>No record found</b></h4>
                    	<%
                     }
                    else{
                    	int count=0;
