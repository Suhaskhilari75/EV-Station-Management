  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto active" href="HeadAdminHome.jsp">Home</a></li>
           <li class="dropdown">
          <a style="color:black;">View Register Details<i class="bi bi-chevron-down"></i></a>
	                <ul>
	                <li class="dropdown"><a class="nav-link scrollto" href="ViewUserRegister.jsp" style="color:black;">User Register Details</a></li>
	                <li class="dropdown"><a class="nav-link scrollto" href="ViewOwnerRegister.jsp" style="color:black;">Owner Register Details</a></li>
	                </ul>
         </li> 
          <li class="dropdown">
    ...
    <!-- ======= Portfolio Section ======= -->
    <section id="portfolio" class="portfolio" style="background-image: url(assets/img/tabs-1.jpg)"><br><br>
    <div class="portfolio" style="background-image: url(assets/img/view1.jpg)">
      <div class="container" data-aos="fade-up" >

        <div class="section-title">
          <h2 style="color:white;">Owner Details</h2>
