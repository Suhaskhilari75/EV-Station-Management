         ...
         <div class="row">
          ...
          <div class="col-md-12">
                    ...
                    <table class="table table-bordered" style="color:black">
                     ...
                     ResultSet rs=st.executeQuery("select * from create_evstation where mobileno='"+mobileno+"'");
                     //while(rs.next())
                     if(rs.next() == false) {
                    	%>
                    	<h4 style="text-align:right;margin-right:70px"><b>No station present</b></h4>
                    	<%
                     }
                    else{
                    	int count=0;
