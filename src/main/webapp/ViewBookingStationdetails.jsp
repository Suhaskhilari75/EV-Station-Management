  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a class="nav-link scrollto active" href="OwnerHome.jsp">Home</a></li>
          <li><a class="nav-link scrollto" href="CreateEVStation.jsp">Create EV Station</a></li>
          <li><a class="nav-link scrollto" href="ViewEVStationdetails.jsp">ManageStationDetails</a></li>
           <li><a class="nav-link scrollto" href="ViewBookingStationdetails.jsp">ManageEVBookingDetails</a></li>
   ...
   <!-- ======= Portfolio Section ======= -->
    <section id="contact" class="contact" style="background-image: url(assets/img/home2.jpg)"><br><br>
    <div class="contact" >
      <div class="container" data-aos="fade-up" >

        <div class="section-title">
          <h2> Booking Station Details</h2>
