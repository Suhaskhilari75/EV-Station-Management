        ...
        <div class="col-xl-9"><br><br><br>
         <div class="row">
          ...
          <form action="AdminLoginController" method="post">
            ...
            <input type="text" name="admin" class="form-control" id=""   placeholder="abc@gmail.com" required>
            <br>
           <input type="password" name="pass" class="form-control" id="pass"   placeholder="enter password" required>
            <br><div class="text-center">
            <center></center><button class="button"  name="login"  type="submit" value="login">login</button></center>
                  <!--   <button class="button" name="reset"  type="reset" >Cancel</button> -->
